...
export const projects = [
  ...
  },
  {
    ...
    "description": "A sample feature grid (“Four Cards”) built with mobile-first CSS Grid and Flexbox, a min() container, and semantic headings. Each card uses data-type variants for colored accent borders, soft shadows, and right-aligned SVG icons. Styles are organized with SCSS partials (_reset, _globals, _variables) compiled into style.css, with utility flow spacing, responsive breakpoints and Google Fonts.",
  ...
  },
  {
    ...
    "description": "A sample community landing page (“Huddle”) built with a mobile-first two-column layout (Flexbox), responsive background art (desktop/mobile), injected header space via CSS vars, a gradient CTA button with hover/focus transitions, inline SVG social icons, and Google Fonts (Poppins/Open Sans)",
