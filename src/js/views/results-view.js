    ...
    projects.forEach((project) => {
      ...
      card.innerHTML = `
        <div class="relative h-56 overflow-hidden">
          ...
          <div class="absolute bottom-4 left-4 inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/20 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.25em] text-white backdrop-blur-sm" style="${catStyle}">${project.category}</div>
        </div>
